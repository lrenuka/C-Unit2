...
namespace spec
{
	...
	public:
		...
		void TeststringMystery(){
			...
			stringMystery(str);
			Assert::AreEqual(true, areEqualStrings("rec-", str), L"stringMystery() failed", 1, 2);

			strcopy(str, "higher-order-functions");
			stringMystery(str);
			Assert::AreEqual(true, areEqualStrings("higher--rde", str), L"stringMystery() failed", 1, 2);

			strcopy(str, "string-literals");
			stringMystery(str);
			Assert::AreEqual(true, areEqualStrings("strin--", str), L"stringMystery() failed", 1, 2);
